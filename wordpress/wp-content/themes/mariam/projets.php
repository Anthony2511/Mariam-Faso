    ...
    <div class="projets">
      <div class="projets__bloc">
        <section class="projets__do">
          <h3 class="projets__do-title" aria-level="3" role="heading">Que faisons-nous ?</h3>
          <p class="projets__do-text">
        ...
        <section class="projets__picture">
          <h3 class="projets__title" aria-level="3" role="heading">Notre projet en image</h3>
          ...
          <a class="projets__galerie-link" href="galerie.html">Voir notre galerie</a>
        </section>
        <section class="projets__video">
          <h3 class="projets__title" aria-level="3" role="heading">Notre dernier voyage en vidéo</h3>
      ...
      <div class="projets__participate">
        <div class="projets__participate-bloc">
          ...
          <a class="projets__link" href="voyages.html" title="Vers la page Voyages">Voyage avec nous</a>
        </div>
      </div>
      <div class="projets__bloc">
        ...
        <section class="projets__realize">
          ...
          <div class="projets__figure-realize">
            <div class="projets__type">
              ...
              <a class="projets__realize-link" href="projet-post.html" title="Vers la page du projet"></a>
            </div>
            <div class="projets__type">
              <figure class="projets__realize-figure">
                <img class="projets__realize-img" src="./images/voyage-two.jpg" width="500" height="331" alt="Photo réalisé pendant le voyage au Burkina Faso">
              </figure>
              <div class="projets__realize-opacity">
                <h4 class="projets__realize-title" aria-level="4" role="heading">Construction d'un puit</h4>
                <p class="projets__realize-date">Mars 2017</p>
            ...
            <div class="projets__type">
              <figure class="projets__realize-figure">
                <img class="projets__realize-img" src="./images/voyage-three.jpg" width="500" height="331" alt="Photo réalisé pendant le voyage au Burkina Faso">
              </figure>
              <div class="projets__realize-opacity">
                <h4 class="projets__realize-title" aria-level="4" role="heading">Construction d'un puit</h4>
                <p class="projets__realize-date">Mars 2017</p>
